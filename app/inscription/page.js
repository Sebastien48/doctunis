...
import {
  Mail, Phone, Users, Eye, EyeOff, ArrowLeft, CheckCircle, XCircle, Loader2
} from 'lucide-react';
import { useRouter } from 'next/navigation';

// Composant réutilisable pour les champs de formulaire
const InputField = ({ label, name, type, value, onChange, error, placeholder, icon, showPasswordToggle }) => {
  return (
    <div className="mb-4">
...
export default function InscriptionPage() {
  ...
  return (
       <div className="min-h-screen flex flex-col bg-cover bg-center" style={{ backgroundImage: "url('images/animations.gif')" }}>
      <button
        onClick={() => router.back()}
